...
<div className="lg:hidden mb-6 mt-6 rounded-lg border border-slate-200 bg-slate-50 p-4 shadow-sm dark:border-slate-700 dark:bg-slate-900">
  ...
  <ul className="space-y-1 text-[15px]">
    <li><a className="text-blue-600 no-underline hover:underline dark:text-blue-300" href="#-모임-통장-관리-서비스--갓생루팅">🏦 프로젝트 개요</a></li>
    <li><a className="text-blue-600 no-underline hover:underline dark:text-blue-300" href="#-주요-문제-해결-사례">🧩 주요 문제 해결 사례</a></li>
    <li className="pl-3 text-xs"><a className="text-slate-500 no-underline hover:text-slate-700 dark:text-slate-300 dark:hover:text-slate-100" href="#문제-1-이체-시-중복-처리-및-데이터-충돌-발생">└ 문제 1: 이체 시 중복 처리</a></li>
    <li className="pl-3 text-xs"><a className="text-slate-500 no-underline hover:text-slate-700 dark:text-slate-300 dark:hover:text-slate-100" href="#문제-2--잔액-업데이트-동시성-충돌">└ 문제 2: 잔액 업데이트 동시성</a></li>
    <li className="pl-3 text-xs"><a className="text-slate-500 no-underline hover:text-slate-700 dark:text-slate-300 dark:hover:text-slate-100" href="#문제-3-이체-중-오류-발생-시-잔액-불일치-문제">└ 문제 3: 이체 중 오류 발생</a></li>
  </ul>
</div>

<div className="mt-3 flex flex-wrap items-center gap-2">
  <span className="inline-flex items-center rounded-md border border-sky-100 bg-sky-50 px-3 py-1 text-sm font-medium text-sky-800 dark:border-sky-900 dark:bg-sky-900/40 dark:text-sky-100">📅 2024.09 ~ 2024.10</span>
  ...
  <span className="inline-flex items-center rounded-md border border-emerald-100 bg-emerald-50 px-3 py-1 text-sm font-medium text-emerald-800 dark:border-emerald-900 dark:bg-emerald-900/40 dark:text-emerald-100">🛠 Spring Boot, Kafka, Redis</span>
</div>

## 1) 프로젝트 개요

- 목표: 모임 구성원의 미션 수행을 기반으로 벌금·상금이 자동 정산되는 **금융형 협업 서비스** 백엔드 구축
- 배경: 혼자 습관 형성에 도전했지만 실패 경험이 반복됨 → 벌금·보상을 팀 단위로 묶어 상호 견제가 되면 효과적이라는 경험에서 출발해 서비스화
...
## 4) ERD
    ...
    ![image.png](https://assets.cvcvcx9.org/images/godLifeRouting/GodLifeRoutine%20v2.png)
...
| 선택지 | 장점 | 단점 |
| --- | --- | --- |
| **1. 낙관적 락** | 성능 우수, 락 경합 없음 | 충돌 시 재시도 필요 |
| **2. 비관적 락** | 완벽한 일관성 보장 | 락 대기시간 증가 |
...
- 미션수행 - 운동하기(장소미션)
    ...
    ![image.png](https://assets.cvcvcx9.org/images/godLifeRouting/image%201.png)
    
- 미션수행 - 물건촬영

![image.png](https://assets.cvcvcx9.org/images/godLifeRouting/image%202.png)

- 베팅하기 - 팀원의 미션 수행 여부를 놓고 배팅

![image.png](https://assets.cvcvcx9.org/images/godLifeRouting/image%203.png)

- 정산 및 캘린더와 갤러리 - 미션 결과를 캘린더와 갤러리에서 확인 및 정산에서 낸 벌금 확인가능

![image.png](https://assets.cvcvcx9.org/images/godLifeRouting/image%204.png)
