...
<div className="my-4 aspect-video overflow-hidden rounded-lg border border-slate-200 shadow-sm dark:border-slate-700">
  <iframe
    className="h-full w-full"
    src="https://www.youtube.com/embed/potFdbd8nD8"
    title="깻냥 미션 알람 데모"
    frameBorder="0"
